/// Flamegor — Blackwing Lair drake triplet (3 of 3).
///
/// Same core mechanics as Firemaw (Shadow Flame cone, Wing Buffet,
/// Flame Buffet). **Distinct**: Flamegor casts `Frenzy` periodically;
...
pub const AURA_FRENZY: SpellId = SpellId(23342);

#[derive(Clone, Debug, PartialEq, Default)]
pub struct FlamegorFsm {
    active: bool,
    done: bool,
}

impl EncounterFsm for FlamegorFsm {
