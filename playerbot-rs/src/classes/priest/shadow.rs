...
const SW_PAIN_RANKS: &[SpellId] = &[
    SpellId(589), SpellId(594), SpellId(970), SpellId(992),
    SpellId(2767), SpellId(10892), SpellId(10893), SpellId(10894),
];
const DEVOURING_PLAGUE_RANKS: &[SpellId] = &[
    SpellId(2944), SpellId(19276), SpellId(19277),
    SpellId(19278), SpellId(19279), SpellId(19280),
];
...
pub fn build_tree() -> Bt {
    Sel(vec![
        ...
        Seq(vec![InCombat, Sel(vec![
            ...
            Seq(vec![TargetMissingAura(VAMPIRIC_EMBRACE), CastOnTarget(VAMPIRIC_EMBRACE)]),
            // Shadow Word: Pain DoT upkeep.
            Seq(vec![TargetMissingAnyRank(SW_PAIN_RANKS), CastOnTarget(SHADOW_WORD_PAIN)]),
            // Instant nuke on CD.
            CastOnTarget(MIND_BLAST),
            // Devouring Plague (Undead racial).
            Seq(vec![TargetMissingAnyRank(DEVOURING_PLAGUE_RANKS), CastOnTarget(DEVOURING_PLAGUE)]),
            // Channel filler.
