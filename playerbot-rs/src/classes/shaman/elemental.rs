...
use crate::{
    ...
    engine::bt::{
        Bt::{self, DropConfiguredTotems, InCombat, TargetIsCasting, CastOnTarget, Cmp},
        Op::AtLeast,
...
fn combat_tree() -> Bt {
    Sel!(
        ...
        super::boost(),
        // Totem upkeep — highest priority after boosts so totems go down
        // as soon as combat starts. Driven by per-bot preferences
