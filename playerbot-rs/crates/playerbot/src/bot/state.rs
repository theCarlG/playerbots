...
use cmangos::{BotRole, BotWorldSnapshot, UnitHandle, World};
...
pub struct BotState {
    ...
    /// Interface to the game (production: `VtableWorld`, tests: `MockInterface`).
    pub interface: Box<dyn World>,
