...
fn is_ranged_spec(class: PlayerClass, spec: PlayerSpec) -> bool {
    use PlayerClass::{Mage, Warlock, Hunter, Priest, Druid, Shaman, Paladin};
    use PlayerSpec::{PriestShadow, PriestDiscipline, PriestHoly, DruidBalance, DruidRestoration, ShamanElemental, ShamanRestoration, PaladinHoly};
    match class {
