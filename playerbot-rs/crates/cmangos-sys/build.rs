fn main() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .allowlist_type("RandomMgrCallbacks")
        .allowlist_type("BotEventRow")
        .allowlist_type("BotWorldDiffSample")
        .allowlist_type("BotTeleportRow")
        .allowlist_type("BotNamedLocationRow")
        .allowlist_type("BotBgQueueEntry")
        .allowlist_type("BotLfgQueueEntry")
        .allowlist_type("BotAhMirrorRow")
        .allowlist_type("BotRealPlayerLevel")
        .allowlist_type("BotStatsRow")
        .allowlist_var("PLAYERBOT_HOLDER_.*")
        .allowlist_var("PLAYERBOT_QUEST_.*")
        .allowlist_var("PLAYERBOT_ARENA_TYPE_.*")
        .allowlist_var("PLAYERBOT_STATS_FLAG_.*")
